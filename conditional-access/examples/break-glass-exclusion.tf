variable "conditional_access_break_glass_group_display_name" {
...
variable "conditional_access_additional_excluded_group_ids" {
...
data "azuread_group" "conditional_access_break_glass" {
  display_name = var.conditional_access_break_glass_group_display_name
}
...
locals {
  conditional_access_standard_excluded_group_ids = distinct(concat(
    ...
    var.conditional_access_additional_excluded_group_ids
  ))
}
